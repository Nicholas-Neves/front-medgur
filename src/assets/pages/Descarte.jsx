      ...
      <section className={Styles.pgdescarte}>
        ...
        <section className={Styles.descarte1}>
          <div className={Styles.textd1}>
            ...
            <button className={Styles.BtnDescartar}>Descartar</button>
            {open && <ModalDescartar onClose={() => setOpen(true)} />}
          </div>
        ...
        <section className={Styles.descarte2}>
          ...
          <p className={Styles.t2}>
            O descarte incorreto de medicamentos contamina o solo, a água e afeta a vida de animais. Além disso, oferece risco à saúde com o uso indevido por outras pessoas. A Medgur está aqui para mudar isso!</p>
        </section>
